...
const History = () => {
  return (
    <div>
      ...
      <section>
        <p style={{ color: "#008080", fontWeight: "700", textAlign: "center" }}>Journey Through Sikkim’s Spiritual History</p>
        <div className={styles.timeline}>
          <p style={{height:"175px",width:"525px"}}>8th Century – Guru Padmasambhava’s Arrival<p>Buddhism is introduced, laying the foundation of Sikkim’s spiritual heritage. Lamas begin establishing meditation centers that evolve into monasteries.</p></p>
        ...
        <div className={styles.timeline}>
          ...
          <p style={{height:"175px",width:"525px"}}>1642 – Namgyal Dynasty Established<p>Phuntsog Namgyal becomes the first Chogyal (king) of Sikkim. Buddhism is declared the state religion, leading to the expansion of monasteries and royal patronage.</p></p>
        </div>
        <div className={styles.timeline}>
          <p style={{height:"175px",width:"525px"}}>1700s – Founding of Major Monasteries<p>Prominent monasteries like Pemayangtse (1670s) are established as royal monasteries. Rumtek Monastery rises as the seat of the Karmapa, becoming an international hub of Tibetan Buddhism.</p></p>
          <img src="./assets/monastery.png" alt="Timeline" style={{height:"80px",width:"80px"}}></img>
        </div>
        <div className={styles.timeline}>
          <img src="./assets/colonial.png" alt="Timeline" style={{height:"80px",width:"80px"}}></img>
          <p style={{height:"175px",width:"525px"}}>19th Century – Colonial Encounters<p>British explorers, scholars, and missionaries document Sikkim’s monasteries, bringing global awareness. This sparks preservation efforts but also introduces challenges from modernization.</p></p>
        </div>
        <div className={styles.timeline}>
          <p style={{height:"175px",width:"525px"}}>Modern Era – Preservation & Digitalization<p>Initiatives like Monastery360 and local heritage projects work to digitize manuscripts, preserve murals, and make monastery history accessible worldwide.</p></p>
          <img src="./assets/digital.png" alt="Timeline" style={{height:"80px",width:"80px"}}></img>
        </div>
      </section>
      <section className={styles.legacysection}>
        <div className={styles.legacy}>
          <p style={{ color: "#008080", fontWeight: "700", textAlign: "center" }}>Legacy of Monasteries in Sikkim</p>
      ...
      <section>
        <p style={{ color: "#008080", fontWeight: "700", textAlign: "center" }}>Did You Know?</p>
        <div className={styles.legacy}>
